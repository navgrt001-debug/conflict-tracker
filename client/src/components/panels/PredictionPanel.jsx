...
<body>
  ...
  <div class="header">
    ...
    <div class="meta" style="margin-top:6px">
      ...
      <strong>Model:</strong> DeepSeek V4 Flash
    </div>
  </div>
  ${scoreRow}
  <div class="body">${htmlBody}</div>
  <div class="disclaimer">
    <strong>Disclaimer:</strong> This report is AI-generated by DeepSeek V4 Flash and is intended for informational purposes only.
